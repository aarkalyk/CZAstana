...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.imageView = [[UIImageView alloc] initWithFrame:CGRectMake(self.contentView.frame.size.width*0.25, self.contentView.frame.size.width*0.1, self.contentView.frame.size.width*0.5, self.contentView.frame.size.width*0.5)];
